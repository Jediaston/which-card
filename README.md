...
- **What's Cooking?** — type a dish name and get its ingredients as a shopping or cooking checklist, with progress tracking, instructions, and favorite-cuisine browsing (Filipino, Thai, Italian, Vietnamese, Taiwanese, Japanese, Mexican, Indian). Pulls recipes from the free [TheMealDB](https://www.themealdb.com) API plus a curated set of local recipes. Live at [https://jediaston.github.io/which-card/whats-cooking/](https://jediaston.github.io/which-card/whats-cooking/).
