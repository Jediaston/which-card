...
- **Medora** — a directory of hospitals, clinics, veterinarians, care homes, and private practices across Bacolod, Silay, and Talisay, with filtering by type/city, search, and sort (name, city, type). Fully self-contained, no network calls beyond loading fonts/icons. Live at [https://jediaston.github.io/which-card/medora/](https://jediaston.github.io/which-card/medora/).
